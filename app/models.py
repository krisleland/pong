...
class User(UserMixin, db.Model):
    ...
    is_paddle_hard = db.Column(db.Integer, index=True, default=0)
    is_paddle_soft = db.Column(db.Integer, index=True, default=0)
...
class Match(db.Model):
    ...
    date_added = db.Column(db.DateTime, default=datetime.utcnow)
    resolved_challenge_id = db.Column(db.Integer, default=None)
